...
import Mantenimientos.MantenimientoParametros;
...
public class FrmParametros extends javax.swing.JFrame {
    ...
    MantenimientoParametros mantenimiento = new MantenimientoParametros();
    
    public FrmParametros() {
        initComponents();
        mantenimiento.ListadoParametros();
        
        if (mantenimiento.ListadoParametros().size() <= 0)
        {
    ...
    private void initComponents() {
        ...
        MantenimientoValor = new javax.swing.JLabel();
        ...
        MantenimientotxtValor = new javax.swing.JTextField();
        ...
        MantenimientoValor.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        MantenimientoValor.setText("Valor");
        ...
        PnlMantenimientoLayout.setHorizontalGroup(
            ...
            .addGroup(PnlMantenimientoLayout.createSequentialGroup()
                ...
                .addGroup(PnlMantenimientoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(MantenimientoValor)
                    .addComponent(MantenimientoCodigo)
                    .addComponent(MantenimientoEstado))
                .addGap(18, 18, 18)
                .addGroup(PnlMantenimientoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(MantenimientotxtEstado, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(MantenimientotxtCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(PnlMantenimientoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(MantenimientotxtValor, javax.swing.GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE)
        ...
        PnlMantenimientoLayout.setVerticalGroup(
            ...
            .addGroup(PnlMantenimientoLayout.createSequentialGroup()
                ...
                .addGroup(PnlMantenimientoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(MantenimientoValor)
                    .addComponent(MantenimientotxtValor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        GeneroTitulo.setText("Mantenimiento Parametros");
    ...
    private void MantenimientobtnGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MantenimientobtnGuardarMouseClicked
        ...
        if (!MantenimientotxtCodigo.getText().equals(""))
        {
            ...
            Parametros parametro = new Parametros (
                    ...
                    MantenimientotxtValor.getText(), 
                    true);

            mantenimiento.AddElemento(parametro);
    ...
    {
        ArrayList<Parametros> lista = mantenimiento.ListadoParametros();
        
        String[] columnNames = {"Codigo","Nombre","Valor","Estado"};
        ...
        for (int i = 0; i < lista.size(); i++)
        {
            ...
            String Valor = lista.get(i).getValor();
            String Nombre = lista.get(i).getNombre();
            Boolean Estado = lista.get(i).getEstado();
            
            Object[] data = {Codigo, Nombre, Valor, Estado};
    ...
    private javax.swing.JLabel MantenimientoValor;
    ...
    private javax.swing.JTextField MantenimientotxtValor;
