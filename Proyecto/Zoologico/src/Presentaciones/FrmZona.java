...
public class FrmZona extends javax.swing.JFrame {
    ...
    MantenimientoZona mantenimiento = new MantenimientoZona ();
    Zona temporalZona;
    ...
    public FrmZona() {
        ...
        if (mantenimiento.ListadoZona().size() <= 0)
        {
    ...
    private void initComponents() {
        ...
        MantenimientoExtension = new javax.swing.JLabel();
        MantenimientotxtExtension = new javax.swing.JTextField();
        ...
        MantenimientoExtension.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        MantenimientoExtension.setText("Extensión:");
                ...
                .addGroup(PnlMantenimientoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(PnlMantenimientoLayout.createSequentialGroup()
                        .addGroup(PnlMantenimientoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(PnlMantenimientoLayout.createSequentialGroup()
                                .addComponent(MantenimientoExtension)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(MantenimientotxtExtension, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        PnlMantenimientoLayout.setVerticalGroup(
            ...
            .addGroup(PnlMantenimientoLayout.createSequentialGroup()
                ...
                .addGroup(PnlMantenimientoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(MantenimientoExtension)
                    .addComponent(MantenimientotxtExtension, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel1.setText("Mantenimiento de Zonas");
    ...
    private void MantenimientobtnGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MantenimientobtnGuardarMouseClicked
        ...
        if (MantenimientotxtNombre.getText().isEmpty() 
                || MantenimientotxtExtension.getText().isEmpty())
        {
            JOptionPane.showMessageDialog(null, "Campo del nombre o extension vacios.", 
        ...
        {
            temporalZona.setCodigo(0);
            temporalZona.setNombre(MantenimientotxtNombre.getText());
            temporalZona.setExtension(Integer.parseInt(MantenimientotxtExtension.getText()));
            mantenimiento.AgregarZona(temporalZona);
        }
        else 
        {    
            temporalZona.setCodigo(Integer.parseInt(MantenimientotxtCodigo.getText()));
            temporalZona.setNombre(MantenimientotxtNombre.getText());    
            temporalZona.setExtension(Integer.parseInt(MantenimientotxtExtension.getText()));
            mantenimiento.ModificarZona(temporalZona);
        }
    ...
    private void BusquedabtnBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BusquedabtnBuscarMouseClicked
        ...
        {
            temporalZona = mantenimiento.BusquedaZona(
                1, 
        ...
        if (temporalZona == null)
            JOptionPane.showMessageDialog(null, "Registro no encontrado.", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
        else
        {
            MantenimientotxtCodigo.setText(String.valueOf(temporalZona.getCodigo()));
            MantenimientotxtNombre.setText(temporalZona.getNombre());
    ...
    private void MantenimientobtnRemoverMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MantenimientobtnRemoverMouseClicked
        mantenimiento.RemoverZona(Integer.parseInt(MantenimientotxtCodigo.getText()));
    ...
    private void ListadobtnEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ListadobtnEditarMouseClicked
        ...
        temporalZona = mantenimiento.BusquedaZonaIndice(ResultadotblLista.getSelectedRow());
        
        MantenimientotxtCodigo.setText(String.valueOf(temporalZona.getCodigo()));
        MantenimientotxtNombre.setText(temporalZona.getNombre());
        MantenimientotxtExtension.setText(String.valueOf(temporalZona.getExtension()));
    ...
    public void LimpiarCampos ()
    {
        ...
        MantenimientotxtExtension.setText("");
    }
    ...
    {
        ArrayList<Zona> lista = mantenimiento.ListadoZona();
        
        String[] columnNames = {"Codigo","Nombre","Extensión"};
        ...
        for (int i = 0; i < lista.size(); i++)
        {
            ...
            int Extension = lista.get(i).getExtension();
            
            Object[] data = {Codigo, Nombre, Extension};
    ...
    private javax.swing.JLabel MantenimientoExtension;
    ...
    private javax.swing.JTextField MantenimientotxtExtension;
