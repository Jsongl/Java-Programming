...
import Mantenimientos.MantenimientoItinerario;
...
public class FrmItinerario extends javax.swing.JFrame {
    ...
    MantenimientoItinerario mantenimiento = new MantenimientoItinerario ();
    ...
    public FrmItinerario() {
        ...
        if (mantenimiento.ListadoItinerario().size() <= 0)
        {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mantenimiento de Itinerarios");
    ...
    private void MantenimientobtnGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MantenimientobtnGuardarMouseClicked
        ...
        {
            temporalItinerario.setCodigo(0);
            temporalItinerario.setDuracion(Integer.parseInt(MantenimientotxtDuracion.getText()));
            temporalItinerario.setLongitud(Integer.parseInt(MantenimientotxtLongitud.getText()));
            temporalItinerario.setMaximoVisitantes(Integer.parseInt(MantenimientotxtMaxVisitantes.getText()));
            temporalItinerario.setNumeroEspecies(Integer.parseInt(MantenimientotxtNumEspecies.getText()));
            temporalItinerario.setZonasId(ObtenerZonasSelecionadas());
            
            mantenimiento.AgregarItinerario(temporalItinerario);
        }
        else 
        {    
            temporalItinerario.setCodigo(Integer.parseInt(MantenimientotxtCodigo.getText()));
            temporalItinerario.setDuracion(Integer.parseInt(MantenimientotxtDuracion.getText()));
            temporalItinerario.setLongitud(Integer.parseInt(MantenimientotxtLongitud.getText()));
            temporalItinerario.setMaximoVisitantes(Integer.parseInt(MantenimientotxtMaxVisitantes.getText()));
            temporalItinerario.setNumeroEspecies(Integer.parseInt(MantenimientotxtNumEspecies.getText()));
            ...
            mantenimiento.ModificarItinerario(temporalItinerario);
        }
    ...
    private void BusquedabtnBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BusquedabtnBuscarMouseClicked
        ...
        {
            temporalItinerario = mantenimiento.BusquedaItinerario(
                Integer.parseInt(BusquedatxtCodigo.getText()));
        }
      
        
        
        if (temporalItinerario == null)
            JOptionPane.showMessageDialog(null, "Registro no encontrado.", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
        else
        {
            MantenimientotxtCodigo.setText(String.valueOf(temporalItinerario.getCodigo()));
            MantenimientotxtDuracion.setText(String.valueOf(temporalItinerario.getDuracion()));
            MantenimientotxtLongitud.setText(String.valueOf(temporalItinerario.getLongitud()));
            MantenimientotxtMaxVisitantes.setText(String.valueOf(temporalItinerario.getMaximoVisitantes()));
            MantenimientotxtNumEspecies.setText(String.valueOf(temporalItinerario.getNumeroEspecies()));
            
            
            MarcarZonas(temporalItinerario.getZonasId());
    ...
    private void MantenimientobtnRemoverMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MantenimientobtnRemoverMouseClicked
        mantenimiento.RemoverItinerario(Integer.parseInt(MantenimientotxtCodigo.getText()));
    ...
    private void ListadobtnEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ListadobtnEditarMouseClicked
        ...
        temporalItinerario = mantenimiento.BusquedaItinerarioIndice(ResultadotblLista.getSelectedRow());
    ...
    {
        ArrayList<Itinerario> lista = mantenimiento.ListadoItinerario();
