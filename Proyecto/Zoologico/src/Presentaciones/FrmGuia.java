...
public class FrmGuia extends javax.swing.JFrame {
    ...
    Guia temporalGuia;
    MantenimientoItinerario CargarItinerario = new MantenimientoItinerario ();
    DefaultListModel ModeloLista = new DefaultListModel();
        
    
    public FrmGuia() {
        initComponents();
        CargarItinerario.CargarDeArchivo();
    ...
    private void initComponents() {
        ...
        MantenimientolstItinerarios = new javax.swing.JList();
        MantenimientoItinerarios = new javax.swing.JLabel();
        ...
        MantenimientolstItinerarios.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(MantenimientolstItinerarios);

        MantenimientoItinerarios.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        MantenimientoItinerarios.setText("Itinerarios:");
                            ...
                            .addGroup(PnlMantenimientoLayout.createSequentialGroup()
                                ...
                                .addGroup(PnlMantenimientoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, PnlMantenimientoLayout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(MantenimientoItinerarios))
    ...
    private void MantenimientobtnGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MantenimientobtnGuardarMouseClicked
        ...
        if (MantenimientotxtNombre.getText().isEmpty()
                ...
                || MantenimientolstItinerarios.getSelectedIndices().length == 0)
        {
        ...
        if (MantenimientotxtCodigo.getText().isEmpty())
        {
            ...
            temporalGuia.setItinerariosId(ObtenerItinerariosSelecionados());
    ...
    private ArrayList<Integer> ObtenerItinerariosSelecionados ()
    {
        int[] list = MantenimientolstItinerarios.getSelectedIndices();
    ...
    private void BusquedabtnBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BusquedabtnBuscarMouseClicked
        ...
        else
        {
            ...
            MarcarItinerarios(temporalGuia.getItinerariosId());
    ...
    private void CargarItinerarios ()
    {
        ...
        for (Itinerario Temporal:CargarItinerario.ListadoItinerario())
        {
            ModeloLista.addElement(Temporal.getCodigo());
        }
        
        MantenimientolstItinerarios.setModel(ModeloLista);
        MantenimientolstItinerarios.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
    }
    
    private void MarcarItinerarios (ArrayList<Integer> ListaIds)
    {
        ...
        MantenimientolstItinerarios.setSelectedIndices(ListaIdsArreglo);
    }
    ...
    public void LimpiarCampos ()
    {
        ...
        MantenimientolstItinerarios.clearSelection();
    }
    ...
    private javax.swing.JLabel MantenimientoItinerarios;
    ...
    private javax.swing.JList MantenimientolstItinerarios;
