    ...
    public void CargarDeArchivo ()
    {
        ...
        try {
          ...
          while ((linea = buferlector.readLine()) != null) {
              ...
              //Movimiento a proxima linea en archivo para carga de Itinerarios.
              linea = buferlector.readLine ();
              
              String [] Itinerarios = linea.split(",");
              ArrayList<Integer> TemporalItinerarios = new ArrayList<> ();
              
              for (String Itinerario:Itinerarios)
              {
                  TemporalItinerarios.add(Integer.parseInt(Itinerario));
              }
              
              TemporalGuia.setItinerariosId(TemporalItinerarios);
